  ...
  return (
    ...
    >
      <div className="flex items-center gap-6 flex-1">
        <div className="w-14 h-14 bg-[#222222] rounded-2xl flex items-center justify-center text-white/20 font-black text-lg group-hover:bg-[#eac072] group-hover:text-[#121212] transition-all duration-300 border border-white/5 shadow-inner">
          {chapter.order}
        </div>
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h4 className="font-extrabold text-white text-lg group-hover:text-[#eac072] transition-colors">{chapter.title}</h4>
            {chapter.isDraft ? (
          ...
          <div className="flex flex-wrap items-center gap-4 text-[10px] text-white/20 font-black uppercase tracking-[0.2em]">
            ...
            {chapter.isEndOfVolume && (
              <>
                <div className="w-1 h-1 bg-white/5 rounded-full" />
                <span className="text-[#eac072] flex items-center gap-2">
      ...
      <div className="flex items-center gap-3" onClick={(e) => e.stopPropagation()}>
        <button 
          ...
          className="w-12 h-12 flex items-center justify-center text-white/30 bg-white/5 hover:bg-[#eac072] hover:text-[#121212] rounded-2xl border border-white/5 transition-all active:scale-90 group/btn"
          title="تعديل الفصل"
        >
  ...
  const HighlightText = ({ text, highlight }: { text: string; highlight: string }) => {
    ...
    return (
      <>
        {parts.map((part, i) => 
          regex.test(part) ? (
            <span key={i} className="text-[#eac072] underline decoration-wavy decoration-[#eac072]/30 underline-offset-4">{part}</span>
          ) : (
            part
          )
        )}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#121212]">
        <div className="relative">
          <div className="w-16 h-16 border-4 border-[#eac072]/20 border-t-[#eac072] rounded-full animate-spin" />
    ...
    return (
      <div className="min-h-screen bg-[#121212] flex items-center justify-center p-4 relative overflow-hidden" dir="rtl">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute -top-24 -left-24 w-96 h-96 bg-[#eac072]/10 rounded-full blur-3xl" />
          <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-[#eac072]/10 rounded-full blur-3xl" />
        </div>
        ...
        >
          ...
          <div className="relative inline-block mb-6">
            <div className="w-20 h-20 bg-[#eac072] rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-[#eac072]/30">
            ...
            <div className={`absolute -bottom-1 -left-1 w-7 h-7 rounded-full flex items-center justify-center border-2 border-[#1e1e1e] shadow-md transition-colors ${
              isPasscodeUnlocked ? 'bg-emerald-500 text-[#121212]' : 'bg-[#121212] text-[#eac072] border-white/10'
            }`}>
          ...
          {!isPasscodeUnlocked ? (
            ...
            <form onSubmit={verifyPasscode} className="space-y-5 text-right">
              <div className="bg-[#121212]/80 p-4 rounded-2xl border border-white/5 text-center">
                <div className="flex items-center justify-center gap-2 text-[#eac072] text-xs font-black uppercase tracking-wider mb-1">
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    placeholder="••••••••"
                    className={`w-full bg-[#121212] border ${passcodeError ? 'border-red-500' : 'border-white/10 focus:border-[#eac072]'} rounded-2xl px-5 py-4 pl-12 text-white font-mono text-center tracking-widest text-lg outline-none transition-all placeholder:text-white/20`}
                    autoFocus
                  />
                  <button
                    type="button"
              ...
              <button 
                ...
                className="w-full flex items-center justify-center gap-3 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] font-black py-4 rounded-2xl transition-all shadow-xl shadow-[#eac072]/20 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 cursor-pointer"
              >
                {isCheckingPasscode ? (
            ...
            <div className="space-y-4">
              ...
              <button 
                onClick={login}
                className="w-full flex items-center justify-center gap-3 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] font-black py-4 rounded-2xl transition-all shadow-xl hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
              >
    ...
    <div className="min-h-screen bg-[#121212] text-white flex flex-col font-sans relative overflow-hidden" dir="rtl">
          ...
          <>
            ...
            >
              <div className="p-6 border-b border-white/5 flex items-center justify-between">
                ...
                <h3 className="font-bold text-lg text-[#eac072] uppercase tracking-widest">القائمة</h3>
              </div>
              <div className="flex-1 overflow-y-auto p-6 space-y-4">
                <button onClick={() => { setView('home'); setShowSidebar(false); }}
                  className={`w-full text-right px-6 py-4 rounded-2xl font-bold transition-all flex items-center gap-4 ${view === 'home' ? 'bg-[#eac072] text-[#121212]' : 'text-white/60 hover:bg-white/5'}`}>
                  <Home className="w-5 h-5" /> <span>الرئيسية</span>
                </button>
                <button onClick={() => { setView('library'); setShowSidebar(false); }}
                  className={`w-full text-right px-6 py-4 rounded-2xl font-bold transition-all flex items-center gap-4 ${view === 'library' ? 'bg-[#eac072] text-[#121212]' : 'text-white/60 hover:bg-white/5'}`}>
                  <Library className="w-5 h-5" /> <span>المكتبة</span>
                </button>
                <button onClick={() => { setView('chapters'); setShowSidebar(false); }}
                  className={`w-full text-right px-6 py-4 rounded-2xl font-bold transition-all flex items-center gap-4 ${view === 'chapters' ? 'bg-[#eac072] text-[#121212]' : 'text-white/60 hover:bg-white/5'}`}>
      ...
      <header className="sticky top-0 z-40 bg-[#1e1e1e]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 bg-[#eac072] rounded-xl flex items-center justify-center shadow-md shadow-[#eac072]/20 group-hover:scale-110 transition-transform">
              <Book className="w-6 h-6 text-[#121212]" />
            </div>
            <div className="flex flex-col">
              <h1 className="text-xl font-normal text-white tracking-wide group-hover:text-[#eac072] transition-colors" style={{ fontFamily: "'New Rocker', system-ui" }}>كوم روايات</h1>
              <p className="text-[10px] text-[#eac072] font-bold uppercase tracking-widest">الموقع الرسمي</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              onClick={logout}
              className="p-2.5 text-white/60 hover:text-[#eac072] hover:bg-[#eac072]/10 rounded-xl transition-all"
              title="تسجيل الخروج"
            >
        ...
        <AnimatePresence mode="wait">
            ...
            <motion.div key="home" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-16">
              ...
              <section>
                <div className="flex items-center justify-between mb-8 px-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#eac072]/10 rounded-xl flex items-center justify-center border border-[#eac072]/20 shadow-lg shadow-[#eac072]/5">
                      <Sparkles className="w-5 h-5 text-[#eac072]" />
                    </div>
                ...
                <div className="flex items-center gap-4">
                  {isAdmin && (
                    <button 
                      ...
                      className="group flex items-center gap-2 px-6 py-3 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] rounded-2xl transition-all duration-300 shadow-lg shadow-[#eac072]/10"
                    >
                      <Plus className="w-4 h-4" />
                      <span className="text-[10px] font-black uppercase tracking-widest">رواية جديدة</span>
                    </button>
                  )}
                  <button onClick={() => setView('library')} className="group flex items-center gap-2 px-6 py-3 bg-white/5 hover:bg-[#eac072] rounded-2xl transition-all duration-500">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-6">
                  {[...novels].reverse().slice(0, 5).map((novel, idx) => (
                    <motion.div 
                      ...
                      className="group relative bg-[#1e1e1e] rounded-[2rem] transition-all duration-500 cursor-pointer overflow-hidden border border-white/5 hover:border-[#eac072]/30 hover:shadow-2xl hover:shadow-[#eac072]/10"
                    >
                        ...
                        <div className="absolute inset-0 p-5 flex flex-col justify-end transform transition-transform duration-500">
                          <div className="space-y-2">
                             ...
                             <div className="pt-2 flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
                               ...
                               <button className="text-[10px] font-black text-[#eac072] uppercase tracking-widest hover:underline">اقرأ الآن</button>
                             </div>
                          </div>
                        </div>
                      </div>
                  ...
                  {latestGlobalChapters.length === 0 ? (
                    ...
                    latestGlobalChapters.map((chapter, idx) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 bg-[#121212] rounded-xl flex items-center justify-center text-[#eac072] font-black group-hover:bg-[#eac072] group-hover:text-[#121212] transition-all">{chapter.order}</div>
                            <div>
                              <h4 className="text-sm font-bold text-white group-hover:text-[#eac072] transition-colors">{chapter.title}</h4>
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                  ...
                  <div className="flex items-center gap-4 w-full lg:w-auto">
                    <div className="relative flex-1 lg:w-96 group">
                      <Search className="absolute right-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#eac072] transition-colors w-5 h-5" />
                      <input type="text" placeholder="ابحث..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}
                        className="w-full bg-[#121212] pr-12 pl-12 py-4 rounded-2xl border border-white/5 text-white outline-none focus:border-[#eac072]/50 font-bold transition-all" />
                      {(searchTerm !== debouncedSearchTerm) && (
                        <div className="absolute left-4 top-1/2 -translate-y-1/2">
                          <Loader2 className="w-4 h-4 text-[#eac072] animate-spin" />
                        </div>
                      )}
                    </div>
                    ...
                    <button 
                      ...
                      className={`relative flex items-center gap-3 px-6 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all border ${
                        ...
                        ? 'bg-[#eac072] text-[#121212] border-[#eac072] shadow-lg shadow-[#eac072]/20'
                    ...
                    {isAdmin && (
                      <button onClick={() => { setEditingNovel({ name: '', description: '', author: user?.displayName || '', coverImages: [''], categories: [], status: 'مستمرة', rating: 0, isAdult: false, isDraft: false }); setView('edit-novel'); }}
                        className="bg-[#eac072] text-[#121212] px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-[#eac072]/10">إضافة</button>
                    )}
                  </div>
                </div>
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                      ...
                      >
                        ...
                        <div className="p-8 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 bg-[#eac072]/10 rounded-2xl flex items-center justify-center border border-[#eac072]/20">
                              <SlidersHorizontal className="w-6 h-6 text-[#eac072]" />
                            </div>
                            <div>
                        ...
                        <div className="p-8 space-y-10 max-h-[60vh] overflow-y-auto scrollbar-hide">
                          ...
                          <section>
                            <div className="flex items-center gap-3 mb-6">
                              <Activity className="w-4 h-4 text-[#eac072]" />
                              ...
                              {[
                                ...
                                <button
                                  ...
                                  className={`flex flex-col items-center gap-3 p-4 rounded-2xl border transition-all ${
                                    ...
                                    ? 'bg-[#eac072]/10 border-[#eac072] shadow-lg shadow-[#eac072]/5' 
                                    : 'bg-white/5 border-white/5 hover:bg-white/10'
                                  }`}
                                >
                                  <status.icon className={`w-5 h-5 ${selectedStatus === status.id ? 'text-[#eac072]' : status.color}`} />
                          ...
                          <section>
                            <div className="flex items-center gap-3 mb-6">
                              <Tags className="w-4 h-4 text-[#eac072]" />
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 text-right" dir="rtl">
                              <button
                                ...
                                className={`flex items-center justify-center p-4 rounded-xl border text-[10px] font-black uppercase tracking-widest transition-all ${
                                  ...
                                  ? 'bg-[#eac072] text-[#121212] border-[#eac072]' 
                        ...
                        <div className="p-8 border-t border-white/5 flex gap-4 bg-white/[0.01]">
                          ...
                          <button 
                            onClick={() => setIsFilterModalOpen(false)}
                            className="flex-1 px-8 py-4 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] font-black text-xs uppercase tracking-widest rounded-2xl transition-all shadow-xl shadow-[#eac072]/20"
                          >
                            تطبيق
                          </button>
                        </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                {filteredNovels.map((novel) => (
                  <motion.div 
                    ...
                    whileHover={{ y: -5 }}
                    onClick={() => { setSelectedNovel(novel); setView('chapters'); }}
                    className="group relative bg-[#1e1e1e] rounded-3xl transition-all duration-500 cursor-pointer overflow-hidden border border-white/5 hover:border-[#eac072]/20 hover:shadow-2xl shadow-black/50"
                  >
                    <div className="aspect-[3/4] relative overflow-hidden">
                      {novel.coverImages?.[0] ? (
                        <img 
          ...
          {false && (
            ...
            >
              ...
              {selectedCategory !== 'الكل' && (
                <span className="absolute -top-1 -left-1 w-3 h-3 bg-[#eac072] rounded-full border-2 border-[#121212]" />
              )}
            </div>
          )}
          {/* Continuing cleanup */}
            ...
            >
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center border border-white/5">
                          <UserIcon className="w-4 h-4 text-[#eac072]" />
                        </div>
                        <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-2xl font-black text-white flex items-center gap-3">
                    <Book className="w-6 h-6 text-[#eac072]" />
                          ...
                          >
                            <div className="flex items-center gap-6">
                              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all border shadow-lg ${
                                isExpanded ? 'bg-[#eac072] border-[#eac072] text-[#121212]' : 'bg-[#121212] border-white/5 text-white/20'
                              }`}>
                                <Layers className="w-6 h-6" />
                              </div>
                              <div className="text-right">
                                <h4 className="font-black text-xl text-white group-hover:text-[#eac072] transition-colors mb-1">{volume.name}</h4>
                                  ...
                                  {isAdmin && (
                                    <div className="flex items-center gap-1.5 mr-3">
                                      <button 
                                        ...
                                        className="flex items-center gap-1 px-3 py-1 bg-[#eac072]/10 hover:bg-[#eac072] text-[#eac072] hover:text-[#121212] rounded-xl text-xs font-black transition-all border border-[#eac072]/20 shadow-sm active:scale-95"
                            ...
                            <motion.div
                              ...
                              className={`w-10 h-10 flex items-center justify-center rounded-xl border transition-colors ${
                                isExpanded ? 'border-[#eac072]/20 text-[#eac072]' : 'border-white/5 text-white/20'
                              }`}
                            >
                                    ...
                                    <div className="py-12 text-center bg-[#121212]/40 rounded-[2rem] border border-dashed border-white/5">
                                      ...
                                      {isAdmin && (
                                        <button
                                          ...
                                          className="inline-flex items-center gap-2 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] px-6 py-3 rounded-xl font-black text-xs transition-all shadow-lg shadow-[#eac072]/10 active:scale-95 cursor-pointer"
                                        >
                                          <Plus className="w-4 h-4" />
                        ...
                        <div className="bg-[#1e1e1e] rounded-[1.5rem] border border-white/5 overflow-hidden shadow-xl transition-all">
                          ...
                          >
                            <div className="flex items-center gap-6">
                              ...
                              <div className="text-right">
                                <h4 className="font-black text-xl text-white group-hover:text-[#eac072] transition-colors mb-1">الفصول العامة</h4>
              ...
              {isAdmin && (
                <div className="mt-16 pt-16 border-t border-white/5">
                  <div className="flex items-center gap-3 mb-8">
                    <div className="w-10 h-10 bg-[#eac072]/10 rounded-xl flex items-center justify-center border border-[#eac072]/20">
                      <Settings2 className="w-5 h-5 text-[#eac072]" />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pb-20">
                    <button 
                      ...
                      className="flex items-center justify-center gap-3 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] px-8 py-5 rounded-[1.8rem] font-black transition-all shadow-xl shadow-[#eac072]/20 active:scale-95 group"
                    >
              ...
              <div className="sticky top-0 z-30 bg-[#1e1e1e]/80 backdrop-blur-xl border-b border-white/5 px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    ...
                    className="w-12 h-12 flex items-center justify-center rounded-2xl bg-white/5 hover:bg-[#eac072] hover:text-[#121212] transition-all border border-white/5"
              ...
              <div className="max-w-4xl mx-auto px-6 py-20">
                ...
                <div className="mt-20 pt-10 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 pb-20">
                  ...
                  <button 
                    ...
                    className="w-full md:w-auto px-10 py-5 rounded-2xl bg-[#eac072] hover:bg-[#d9af60] text-[#121212] font-black flex items-center justify-center gap-3 transition-all shadow-xl shadow-[#eac072]/20 disabled:opacity-20"
                  >
                    الفصل التالي
                ...
                >
                  <div className="p-8 border-b border-white/5 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="w-10 h-10 bg-[#eac072]/20 rounded-xl flex items-center justify-center">
                        <Type className="w-5 h-5 text-[#eac072]" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-10 space-y-10">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <input 
                          ...
                          className="flex-1 accent-[#eac072] h-1 bg-white/5 rounded-full appearance-none cursor-pointer"
                        />
                         <button 
                    ...
                    <div className="space-y-4">
                      ...
                      <input 
                        ...
                        className="w-full accent-[#eac072] h-1 bg-white/5 rounded-full appearance-none cursor-pointer"
                      />
                    </div>
                          ...
                          <button
                            ...
                            className={`py-3 rounded-xl border font-black text-xs transition-all ${
                              readerSettings.fontWeight === weight 
                                ? 'bg-[#eac072] border-[#eac072] text-[#121212]' 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                  ...
                  <div className="lg:col-span-8 space-y-8">
                    ...
                    <div className="bg-[#1e1e1e] p-10 rounded-[2.5rem] border border-white/5 shadow-xl relative overflow-hidden">
                      <div className="absolute top-0 right-0 w-64 h-64 bg-[#eac072]/5 rounded-full blur-[100px] -mr-32 -mt-32 pointer-events-none" />
                      
                      <div className="flex items-center gap-3 mb-8 relative z-10">
                        <div className="w-10 h-10 bg-[#eac072]/10 rounded-xl flex items-center justify-center border border-[#eac072]/20">
                          <Book className="w-5 h-5 text-[#eac072]" />
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        <div className="md:col-span-2">
                          ...
                          <input 
                            ...
                            className="w-full px-6 py-5 rounded-2xl border border-white/5 bg-[#121212] text-white focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all font-bold placeholder:text-white/10"
                        ...
                        <div>
                          ...
                          <input 
                            ...
                            className="w-full px-6 py-5 rounded-2xl border border-white/5 bg-[#121212] text-white focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all font-bold"
                        ...
                        <div className="md:col-span-2">
                          ...
                          <textarea 
                            ...
                            className="w-full px-6 py-5 rounded-2xl border border-white/5 bg-[#121212] text-white focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all leading-relaxed resize-none font-medium text-sm scrollbar-hide"
                    ...
                    <div className="bg-[#1e1e1e] p-10 rounded-[2.5rem] border border-white/5 shadow-xl">
                      ...
                      <div className="space-y-4">
                            ...
                            >
                              <div className="relative flex-1">
                                <input 
                                  ...
                                  className="w-full pl-6 pr-14 py-5 rounded-2xl border border-white/5 bg-[#121212] text-white focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all font-mono text-xs overflow-hidden text-ellipsis"
                                  placeholder={`رابط الصورة ${idx + 1}...`}
                                />
                                <div className="absolute inset-y-0 right-6 flex items-center pointer-events-none text-white/20 group-focus-within:text-[#eac072] transition-colors">
                        ...
                        <button
                          ...
                          className="w-full py-5 flex items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-white/5 text-white/20 hover:border-[#eac072]/40 hover:text-[#eac072] hover:bg-[#eac072]/5 transition-all group mt-2"
                        >
                  ...
                  <div className="lg:col-span-4 space-y-8">
                          ...
                          <div className="flex items-center justify-between mb-4">
                            ...
                            {isAdmin && (
                              <button 
                                type="button"
                                onClick={addCategory}
                                className="w-8 h-8 bg-[#eac072]/10 text-[#eac072] hover:bg-[#eac072] hover:text-[#121212] rounded-lg flex items-center justify-center transition-all border border-[#eac072]/20 shadow-sm"
                                title="إضافة تصنيف جديد"
                              >
                                <Plus className="w-4 h-4" />
                              </button>
                                ...
                                <div key={cat.id} className="relative group/cat">
                                  <button
                                    ...
                                    className={`px-4 py-2.5 rounded-xl text-[10px] font-black transition-all border shadow-sm ${
                                      isSelected 
                                        ? 'bg-[#eac072] text-[#121212] border-[#eac072] scale-110' 
                    ...
                    <div className="p-8 bg-[#121212] rounded-[2.5rem] border border-white/5 relative overflow-hidden group">
                      <div className="absolute top-0 right-0 w-48 h-48 bg-[#eac072]/5 rounded-full blur-[80px] -mr-24 -mt-24 pointer-events-none" />
                      ...
                      <div className="space-y-8 relative z-10">
                        ...
                        <div className="space-y-6">
                          <div className="space-y-3">
                            <h3 className="font-black text-2xl text-white leading-tight group-hover:text-[#eac072] transition-colors">
                          ...
                          <div className="flex flex-wrap items-center gap-3">
                            ...
                            <div className={`px-4 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest border shadow-sm ${
                              ...
                              'bg-[#eac072]/10 border-[#eac072]/20 text-[#eac072]'
                            }`}>
                ...
                <div className="fixed bottom-0 left-0 right-0 z-[100] p-6 flex justify-center pointer-events-none">
                  ...
                  >
                    <button 
                      type="submit"
                      disabled={loading}
                      className="flex-1 flex items-center justify-center gap-3 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] font-black py-5 rounded-[1.8rem] transition-all shadow-xl shadow-[#eac072]/20 disabled:opacity-50 group active:scale-95"
                    >
              ...
              <form onSubmit={saveChapter} className="space-y-10 pb-20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 relative z-20">
                    <div className="md:col-span-5">
                      ...
                      <div className="relative group">
                        <input 
                          ...
                          className="w-full pl-6 pr-14 py-5 rounded-2xl border border-white/5 bg-[#121212] text-white focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all font-bold"
                          placeholder="أدخل عنوان الفصل..."
                        />
                        <Type className="absolute right-6 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20 group-focus-within:text-[#eac072] transition-colors" />
                      </div>
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative group">
                        <input 
                          ...
                          className="w-full pl-6 pr-14 py-5 rounded-2xl border border-white/5 bg-[#121212] text-white focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all font-bold"
                        />
                        <Hash className="absolute right-6 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20 group-focus-within:text-[#eac072] transition-colors" />
                      </div>
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative group">
                        ...
                        />
                        <Calendar className="absolute right-6 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20 group-focus-within:text-[#eac072] transition-colors" />
                      </div>
                    </div>
                      ...
                      <button
                        ...
                        className={`flex items-center gap-3 px-8 py-4 rounded-2xl border transition-all font-black text-[10px] uppercase tracking-widest ${
                          editingChapter.isEndOfVolume 
                            ? 'bg-[#eac072]/10 border-[#eac072]/40 text-[#eac072]' 
                            : 'bg-[#121212] border-white/5 text-white/20 hover:border-white/10 hover:text-white'
                        }`}
                      >
                        <div className={`w-4 h-4 rounded shadow-inner flex items-center justify-center border ${editingChapter.isEndOfVolume ? 'bg-[#eac072] border-transparent' : 'bg-transparent border-white/10 text-transparent'}`}>
                ...
                <div className="bg-[#1e1e1e] p-10 rounded-[2.5rem] border border-white/5 shadow-xl relative overflow-hidden z-10">
                  ...
                  <div className="flex items-center justify-between mb-8 relative z-10">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#eac072]/10 rounded-xl flex items-center justify-center border border-[#eac072]/20">
                        <FileText className="w-5 h-5 text-[#eac072]" />
                      </div>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <button
                        ...
                        className="flex items-center gap-3 px-6 py-4 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] rounded-2xl transition-all text-[10px] font-black uppercase tracking-widest shadow-xl shadow-[#eac072]/20 group active:scale-95"
                      >
                  ...
                  <div className="relative group z-10">
                    <div className="absolute inset-0 bg-[#0a0a0a]/50 rounded-[2rem] blur-2xl -z-10 group-focus-within:bg-[#eac072]/5 transition-colors" />
                    <textarea 
                      ref={textareaRef}
                      required
                      rows={25}
                      ...
                      className="w-full px-10 py-10 rounded-[2.5rem] border border-white/5 bg-[#121212]/90 text-white/90 focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all leading-[2] resize-none font-medium text-lg scrollbar-hide shadow-inner"
      ...
      <AnimatePresence>
        {showImagePopup && (
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
            ...
            >
              <div className="p-8 border-b border-white/5 flex items-center justify-between bg-gradient-to-r from-[#eac072]/10 to-transparent">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#eac072]/20 rounded-xl flex items-center justify-center border border-[#eac072]/30">
                    <ImageIcon className="w-5 h-5 text-[#eac072]" />
                  </div>
              ...
              <div className="p-10 space-y-8">
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative group">
                      <input 
                        ...
                        className="w-full pl-6 pr-14 py-5 rounded-2xl border border-white/5 bg-[#121212] text-white focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all font-mono text-xs group-hover:border-white/10"
                        autoFocus
                      />
                      <Link className="absolute right-6 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#eac072] transition-colors w-4 h-4" />
                    </div>
                  </div>
                  ...
                  <button 
                    ...
                    disabled={!imageUrl}
                    className="w-full py-5 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] font-black rounded-2xl transition-all shadow-xl shadow-[#eac072]/20 disabled:opacity-50 active:scale-95"
                  >
                    إدراج في المحتوى
                  </button>
                </div>
      ...
      <AnimatePresence>
        {selectingVolumeForChapters && (
          <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
            ...
            >
              {/* Header */}
              <div className="p-6 md:p-8 border-b border-white/5 flex items-center justify-between bg-gradient-to-r from-[#eac072]/10 to-transparent">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#eac072]/20 rounded-xl flex items-center justify-center border border-[#eac072]/30">
                    <Layers className="w-5 h-5 text-[#eac072]" />
                  </div>
                  <div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
                  <div className="relative w-full sm:w-auto flex-1">
                    <input 
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl border border-white/5 bg-[#121212] text-white text-xs focus:ring-2 focus:ring-[#eac072]/50 outline-none transition-all"
                    />
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 rounded-2xl border transition-all cursor-pointer flex items-center justify-between ${
                            isSelected 
                              ? 'bg-[#eac072]/10 border-[#eac072]/40 text-white' 
              ...
              <div className="p-6 border-t border-white/5 bg-[#121212]/80 flex items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-[#eac072] hover:bg-[#d9af60] text-[#121212] font-black text-xs rounded-xl transition-all shadow-lg shadow-[#eac072]/20 flex items-center gap-2 disabled:opacity-50"
                >
